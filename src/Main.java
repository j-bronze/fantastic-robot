...
public class Main {
    public static void main(String[] args) {
        ...
        if (userInput < PadTypes.length && userInput > 0) {
        ...
        if (userInput < Covers.length && userInput > 0) {
        ...
        if (userInput < Bindings.length && userInput > 0) {
        ...
        if (userInput < Sizes.length && userInput > 0) {
            ...
            System.out.println("Please choose one more: ");
            userInput = scanner.nextInt();
        }
        ...
        if (padType.contentEquals("sketch book") ){
